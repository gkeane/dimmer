...
<div style="clear: left;"></div>
    ...
    <ul>
      ...
      <li><strong>Projected  vs Actual Lumen Output at 50% dimmer setting
        ...
        <ul>
          <li>Accuracy  of lumen output at 50% = lumen output at 50% dimmer setting ÷ (MLO x 0.5) </li>
        </ul>
      </li>

      <li><strong>Projected  vs Actual Lumen Output at 20% dimmer setting
      </strong>
      <ul><li>Accuracy  of lumen output at 20% = lumen output at 20% dimmer setting ÷ (MLO x 0.2) </li></ul></li>

      <li><strong>Lumen  efficiency at 50%</strong> = lumens per watt at 50% dimmer setting</li>
    </ul>
