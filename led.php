...
<body>
    ...
    <form method="get" action="led.php">
        ...
        <select class="dropdown" name="dimmer" onchange=this.form.submit()>
            ...
            $sql = "SELECT dimmer,b.actual,r2,refire_scale, calc_50, calc_20, lumen_watt, total FROM dimmer inner join dimmer_names b on b.dimmer=dimmer.dimmer where led='".$leds."'";
            //echo $sql;
